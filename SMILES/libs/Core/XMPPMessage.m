...
- (BOOL)isChatMessage
{
	return [[[self attributeForName:@"type"] stringValue] isEqualToString:@"chat"] || [[[self attributeForName:@"type"] stringValue] isEqualToString:@"sticker"] || [[[self attributeForName:@"type"] stringValue] isEqualToString:@"ikonia"] || [[[self attributeForName:@"type"] stringValue] isEqualToString:@"groupchat"];
}
