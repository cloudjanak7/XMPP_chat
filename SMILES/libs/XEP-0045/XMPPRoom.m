...
- (XMPPMessage *)sendMessage:(NSString *)msg
{
    ...
    [message addAttributeWithName:@"id" stringValue:[NSString stringWithFormat:@"%@__%lf", [roomJID full], [NSDate timeIntervalSinceReferenceDate]]];
